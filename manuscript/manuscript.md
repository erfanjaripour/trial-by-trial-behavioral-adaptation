...
The dataset comprised participants completing a four-arm restless bandit task over repeated trials. The task included three payoff groups (2, 3, and 4), which were treated as a categorical predictor. All analyses accounted for the repeated-measures structure of the data by including participant-level random effects.
...
The analyzed dataset contained 139,816 trial-level observations from 965 participants. No participants were excluded during the preprocessing workflow. There were no missing reward observations or missing values for payoff-maximizing choice. One reaction-time observation was missing. Choice switching was structurally undefined when no preceding observed choice from the immediately preceding trial was available, resulting in 4,022 structurally missing choice-switch observations. No additional choice-switch missingness was identified.
...
After preprocessing, the analysis dataset contained 965 participants and 139,816 trial-level observations. No participants were excluded during the preprocessing workflow. There were no missing reward observations or missing payoff-maximizing-choice observations. One reaction-time observation was missing. Choice switching was structurally undefined when no preceding observed choice from the immediately preceding trial was available, and these observations were excluded from the choice-switching analysis. Outcome-specific analyzed sample sizes are reported in Table 1.
