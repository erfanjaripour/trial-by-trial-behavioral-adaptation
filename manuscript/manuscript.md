...
All analysis scripts, preprocessing code, model specifications, generated figures, summary tables, and reproducibility materials are available in the project repository ([https://github.com/erfanjaripour/reinforcement-learning-trajectories](https://github.com/erfanjaripour/reinforcement-learning-trajectories)). The repository also includes the computational environment information required to reproduce the analyses. Processed data and derived outputs were generated directly from the raw dataset using the documented analysis pipeline.
